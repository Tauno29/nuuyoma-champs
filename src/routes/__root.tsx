...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PAGENTS MODELLING SYS — Live Judging" },
      { name: "description", content: "Live judging app for the PAGENTS MODELLING SYS Competition." },
      { charSet: "utf-8" },
      { property: "og:title", content: "PAGENTS MODELLING SYS — Live Judging" },
      { property: "og:description", content: "Live judging app for the PAGENTS MODELLING SYS Competition." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "PAGENTS MODELLING SYS — Live Judging" },
      { name: "twitter:description", content: "Live judging app for the PAGENTS MODELLING SYS Competition." },
